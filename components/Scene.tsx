...
export const Scene: React.FC<SceneProps> = ({ 
  ...
  // Fixed: use ThreeEvent<PointerEvent> to access clientX and stopPropagation
  ...
  // Fixed: use ThreeEvent<PointerEvent> to access clientX
  ...
  useFrame((state, delta) => {
    ...
    if (groupRef.current) {
        ...
        if (!isDragging.current && !isHandActiveRef.current) {
             ...
             lastHandX.current = handXRef.current; 
        }
  ...
  return (
    <>
      ...
      <EffectComposer disableNormalPass>
        <Bloom 
          luminanceThreshold={0.8} // Higher threshold for white background
          mipmapBlur 
          intensity={0.4} 
          radius={0.3} 
        />
