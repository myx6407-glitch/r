...
// Custom Shader Material for the Foliage - Optimized for White Background
const foliageVertexShader = `
  ...
  void main() {
    ...
    gl_PointSize = (aSize * 1.5) * (300.0 / -mvPosition.z);

    // Color logic - Adjusted for White Background (More saturated, less neon)
    vec3 colPink = vec3(0.9, 0.0, 0.6);     // Saturated Pink
    vec3 colYellow = vec3(0.9, 0.7, 0.0);   // Golden Yellow
    vec3 colBlue = vec3(0.0, 0.5, 0.9);     // Deep Azure
    ...
    vColor = baseColor + vec3(twinkle * 0.05);
